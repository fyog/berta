...
public class Universe extends Canvas implements ActionListener {
	...
	private static final int SIM_WINDOW_WIDTH = 800;
	private static final int SIM_WINDOW_LENGTH = 800;
	Mass[] masses;
	...
	public void paint(Graphics g) {
		...
		for (Mass m : masses) {
			...
			g.fillOval((int) m.getPosition().getX(), 
				(int) m.getPosition().getY(), (int) m.getPosition().getZ()/10, (int) m.getPosition().getZ()/10);
		}
	...
	public void setUpUniverse() {
		...
		this.setSize(SIM_WINDOW_WIDTH, SIM_WINDOW_LENGTH);
		...
		reset_button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ThreeVector pos2 = new ThreeVector(400, 400, 100);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		ThreeVector vel1 = new ThreeVector(-5, 0, 0);
		ThreeVector vel2 = new ThreeVector(5, 0, 0);
		Mass[] masses = {new Mass(5, pos1, vel1, 1, Color.RED), new Mass(5000,
